        ...
        <div className="row">
          <div className="col-xs-3 col-lg-3 align-top">
            <label htmlFor="dimmer-switch">
              ...
              <Switch
                ...
                checkedIcon={
                  <div style={{ paddingLeft: "2px", color: "white" }}>full</div>
                }
                uncheckedIcon={
                  <div style={{ paddingLeft: "2px", color: "white" }}>dim</div>
                }
          ...
          <div className="col-xs-3 col-lg-3 align-top">
            <label htmlFor="rotation-switch">
              <span className="align-top" style={{ padding: "5px" }}>
                Clockwise:
              </span>
              <Switch className="react-switch" id="rotation-switch" />
            </label>
          </div>
          <div className="col-xs-6">
            <span className="text-muted">
              [<strong>props</strong> are persisted in this example when you
              return on same visit (or HMR))]
            </span>
          </div>
        </div>
        <div className="row">
          <div className="col-xs-12 col-md-6">
            ...
            >
              <Scene>
                <freeCamera
                  name="camera1"
                  position={new Vector3(0, 5, -12)}
                  setTarget={{ target: new Vector3(0, 1, 0) }}
                />
                <hemisphericLight
                  name="light1"
                ...
                <box name="box" size={4} position={new Vector3(0, 1, 0)}>
                  <SingleAxisRotateMeshBehavior
                    rpm={this.props.clockwise ? 12 : -12}
                    axis={Axis.Y}
                  />
                  <standardMaterial
                    name="mat1"
